...
export default function Trailer() {
  ...
  return (
    <section className="relative py-28 px-6 bg-cream text-center md:px-12 overflow-hidden">
      ...
      {/* Video with editorial frame */}
      <div className="relative max-w-[800px] mx-auto">
        {/* Decorative offset shadow */}
        <div className="absolute -bottom-2 -right-2 inset-x-2 h-full bg-ink/5 -z-10" />

        <div className="relative border-2 border-ink shadow-[0_12px_40px_rgba(27,22,18,0.12)] aspect-video bg-ink overflow-hidden">
          <video
            ref={videoRef}
        ...
        <div className="mt-4 flex justify-between items-center px-1">
          <span className="font-mono text-[0.55rem] tracking-[0.1em] uppercase text-ink/25">
            Full walkthrough
          </span>
          <span className="font-mono text-[0.55rem] tracking-[0.1em] uppercase text-ink/25">
